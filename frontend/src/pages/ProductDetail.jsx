...
export default function ProductDetail() {
  ...
  if (!product) return <div style={{ textAlign: 'center', padding: '4rem', fontFamily: 'var(--fs)', fontSize: '1.5rem' }}>Loading...</div>
    ...
    <div style={styles.wrap}>
      <div style={styles.grid}>
        ...
        <div style={styles.imgWrap}>
          ...
          {product.badge && <span style={{ ...styles.badge, background: product.badge === 'sale' ? '#7a3e2a' : 'var(--rose)' }}>{product.badge.toUpperCase()}</span>}
        </div>
        ...
        <div style={styles.details}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '.8rem', marginTop: '1.5rem' }}>
            <button className="btn-primary" style={{ padding: '14px', width: '100%' }} onClick={handleAddToCart}>Add to Bag</button>
...
const styles = {
  wrap: { maxWidth: 1100, margin: '3rem auto', padding: '0 5%' },
