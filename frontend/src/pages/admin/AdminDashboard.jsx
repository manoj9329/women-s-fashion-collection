  ...
  return (
    <div style={styles.wrap}>
      ...
      <div style={styles.header}>
        ...
        <p style={{ fontSize: '.78rem', color: 'var(--mid)' }}>
      ...
      <div style={styles.statsGrid}>
        {[
          ...
          { label: 'Active Listings', val: activeProducts },
          { label: 'Total Orders', val: totalOrders },
          { label: 'Revenue', val: `₹${Math.round(revenue / 1000)}K` }
        ].map(s => (
        ...
        <div style={styles.grid}>
          ...
          <div style={styles.formCard}>
            ...
            <h3 style={styles.formTitle}>
              {editId ? 'Edit Product' : 'Add New Dress'}
            </h3>
...
const styles = {
  ...
  orderHead: {
    display: 'grid',
    gridTemplateColumns:
      '60px 1fr 100px 120px 100px 140px',
    gap: '.5rem',
    padding: '.7rem 1rem',
    background: '#f5ede0',
    fontSize: '.62rem',
